...
public final class ForgeSkillConfigStore {
    ...
    private static void save() {
        try {
            ...
            Constants.LOG.warn("Failed to create Forge skill config {}", PATH, exception);
        }
    }
}
