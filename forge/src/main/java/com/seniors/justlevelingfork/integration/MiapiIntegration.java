...
public final class MiapiIntegration {
    ...
    public static boolean isModularItem(ItemStack stack) {
        ...
        try {
            ...
            Constants.LOG.warn("Failed to check Miapi modular item state.", exception);
            return false;
        }
    }
    ...
    public static List<ResourceLocation> getModuleIds(ItemStack stack) {
        ...
        try {
            ...
            Constants.LOG.warn("Failed to read Miapi module IDs.", exception);
            return List.of();
        }
    }
    ...
    private static boolean initialize() {
        ...
        try {
            ...
            Constants.LOG.warn("Miapi is loaded but the integration could not initialize.", exception);
        }
