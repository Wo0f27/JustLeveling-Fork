...
public final class ForgeKubeJSIntegration {
    private ForgeKubeJSIntegration() {
    }

    public static void load() {
        AptitudeLevelUpEvents.setCancellationHook(ForgeKubeJSIntegration::postLevelUpEvent);
    }
